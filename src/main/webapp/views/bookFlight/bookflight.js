...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if(!flight){
    ...
    root.innerHTML = `
      <div class="bg-white p-6 rounded-xl shadow-md text-center">
        ...
        <div><a href="../flightf/flight.jsp" class="px-4 py-2 bg-orange-500 text-white rounded">Volver a vuelos</a></div>
      </div>
    `;
    return;
  }
  ...
  document.getElementById('btn-back').addEventListener('click', ()=> location.href = '../flightf/flight.jsp');

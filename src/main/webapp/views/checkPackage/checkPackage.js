  ...
  if(!mine.length){
    container.innerHTML = `
      <div class="col-span-full p-6 rounded-xl bg-white shadow text-center text-sm text-gray-600">
        ...
        <div class="mt-3">
          <a href="../createPackage/createPackage.jsp" class="inline-block px-4 py-2 bg-brand text-white rounded-lg text-sm hover:brightness-110">
      ...
      <article class="bg-white rounded-xl shadow hover:shadow-lg transition flex flex-col overflow-hidden">
        ...
        <div class="p-4 flex flex-col gap-3 flex-1">
          ...
          <div class="mt-auto flex items-center justify-between pt-2 border-t">
            ...
            <a href="../createPackage/createPackage.jsp" class="text-xs px-2 py-1 rounded border text-brand hover:bg-brand hover:text-white transition">
              Editar
            </a>
          </div>
        </div>

...
<!-- Panel flotante -->
<aside id="leftPanel"
       class="fixed top-[100px] left-4 bg-brand text-white rounded-2xl shadow-lg p-3 flex flex-col gap-2 w-[180px] z-50 opacity-90 hover:opacity-100 transition
           hidden md:flex"> <!-- Oculto en móviles, visible desde md -->

...
@WebServlet("/pdf/package")
public class PDFPackageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            String fileName = String.format("%s_%s_%d.pdf", nickname, timestamp, packageId);
            resp.setHeader("Content-Disposition", "attachment; filename=paquete_" + fileName);
